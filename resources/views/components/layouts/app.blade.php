...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
            ...
            <style>
                ...
                body {
                    ...
                    background:
                        ...
                        linear-gradient(180deg, #040914 0%, var(--color-night) 18%, #16314f 18%, #16314f 23%, var(--color-paper) 23%, var(--color-paper) 100%);
                }
    ...
    <body class="bg-[var(--color-ink)] text-white antialiased">
        ...
        <div class="site-shell">
            ...
            <footer id="site-footer" class="mt-12 hidden border-t border-white/8 bg-[linear-gradient(180deg,rgba(7,17,31,0.96),rgba(4,9,20,1))] md:block">
                <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
                    <div class="mb-8 grid gap-4 rounded-[2rem] border border-white/8 bg-white/5 p-5 md:grid-cols-[1.25fr_0.75fr_0.75fr] md:items-center md:p-6">
                        <div>
                            <p class="footer-title">Support channels</p>
                            <h2 class="mt-3 font-display text-2xl font-bold text-white">Support buyers, renters, job seekers and sellers from one marketplace.</h2>
                            <p class="mt-2 max-w-xl text-sm leading-6 text-white/62">Keep trusted support and onboarding channels visible so people can move from browsing to conversation fast across every category.</p>
                        </div>
                        <a href="https://wa.me/250788572481?text=Hi%2C%20I%20need%20support" target="_blank" rel="noreferrer" class="rounded-[1.5rem] border border-white/10 bg-white/6 px-5 py-4 transition hover:-translate-y-0.5 hover:bg-white/8">
                            <p class="text-xs font-semibold uppercase tracking-[0.22em] text-[var(--color-sand)]">Marketplace support</p>
                    ...
                    <div class="grid gap-8 border-b border-white/8 pb-8 lg:grid-cols-[1.2fr_0.8fr_0.8fr_0.8fr_0.8fr]">
                        <div>
                            ...
                            <div class="mt-5 flex flex-wrap gap-3 text-sm">
                                ...
                                <a href="https://www.instagram.com/connectify.rw/" target="_blank" rel="noreferrer" class="footer-link">Instagram</a>
                                <a href="https://x.com/CarconnectRw" target="_blank" rel="noreferrer" class="footer-link">X</a>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-4 space-y-3">
                                ...
                                <a href="https://wa.me/250788572481?text=Hi%2C%20I%20need%20support" target="_blank" rel="noreferrer" class="footer-link block">Contact support</a>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-4 space-y-3">
                                ...
                                <a href="{{ route('home', ['transaction_type' => 'sale']) }}" class="footer-link block">Buy and sell</a>
                                <a href="{{ route('home', ['transaction_type' => 'rent']) }}" class="footer-link block">Rentals</a>
                                <a href="{{ route('home', ['transaction_type' => 'hire']) }}" class="footer-link block">Jobs and hiring</a>
                        ...
                        <div>
                            ...
                            <div class="mt-4 space-y-3">
                                ...
                                <a href="{{ route('home', ['country' => 'Rwanda']) }}" class="footer-link block">Rwanda listings</a>
                                <a href="{{ route('home', ['country' => 'Kenya']) }}" class="footer-link block">Kenya listings</a>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col gap-3 pt-6 text-sm text-white/50 md:flex-row md:items-center md:justify-between">
                        ...
                        <div class="flex flex-wrap gap-4">
                            ...
                            <a href="https://wa.me/250788572481?text=Hi%2C%20I%20need%20support" target="_blank" rel="noreferrer" class="footer-link">Contact</a>
                        </div>
                    </div>
                </div>
            </footer>

            <nav class="fixed inset-x-0 bottom-0 z-50 border-t border-white/10 bg-[rgba(7,17,31,0.82)] px-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] pt-3 backdrop-blur-xl md:hidden">
                <div class="mx-auto grid max-w-lg grid-cols-5 items-end gap-2 rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] px-2 py-2 shadow-[0_-18px_50px_-26px_rgba(0,0,0,0.7)]">
                    <a href="{{ route('home') }}" class="flex flex-col items-center gap-1 rounded-2xl px-2 py-2 text-[11px] font-medium text-white/78 transition hover:bg-white/6 hover:text-white">
                    ...
                    <a href="{{ route('home') }}#categories" class="flex flex-col items-center gap-1 rounded-2xl px-2 py-2 text-[11px] font-medium text-white/78 transition hover:bg-white/6 hover:text-white">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" class="h-5 w-5">
                    ...
                    <a href="/seller/register" class="-mt-7 flex flex-col items-center gap-1">
                        <span class="flex h-14 w-14 items-center justify-center rounded-[1.5rem] bg-[linear-gradient(135deg,var(--color-ocean),#8fd0ff)] text-[var(--color-ink)] shadow-[0_22px_45px_-18px_rgba(29,143,255,0.8)] ring-4 ring-[rgba(7,17,31,0.88)] transition hover:-translate-y-0.5">
                    ...
                    <a href="https://wa.me/250788572481?text=Hi%2C%20I%20need%20support" target="_blank" rel="noreferrer" class="flex flex-col items-center gap-1 rounded-2xl px-2 py-2 text-[11px] font-medium text-white/78 transition hover:bg-white/6 hover:text-white">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" class="h-5 w-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M7 10.5h10M7 14h6" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M20 12c0 4.418-3.582 8-8 8-1.258 0-2.448-.29-3.507-.807L4 20l.807-4.493A7.963 7.963 0 0 1 4 12c0-4.418 3.582-8 8-8s8 3.582 8 8Z" />
                        </svg>
                        <span>Chat</span>
                    </a>
                    <a href="#mobile-utility" class="flex flex-col items-center gap-1 rounded-2xl px-2 py-2 text-[11px] font-medium text-white/78 transition hover:bg-white/6 hover:text-white">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" class="h-5 w-5">
